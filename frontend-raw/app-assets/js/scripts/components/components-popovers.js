...
(function (window, document, $) {
  ...
  // Settings Popover
  var settingsPopoverTrigger = document.getElementById('settings-popover');
  if (settingsPopoverTrigger) {
    var settingsPopover = new bootstrap.Popover(settingsPopoverTrigger, {
      title: 'Settings',
    ...
    settingsPopoverTrigger.addEventListener('show.bs.popover', function () {
      console.log('Settings popover is about to be shown.');
    });

    settingsPopoverTrigger.addEventListener('shown.bs.popover', function () {
      console.log('Settings popover is now shown.');
    });

    settingsPopoverTrigger.addEventListener('hide.bs.popover', function () {
      console.log('Settings popover is about to be hidden.');
    });

    settingsPopoverTrigger.addEventListener('hidden.bs.popover', function () {
      console.log('Settings popover is now hidden.');
    });
  }
