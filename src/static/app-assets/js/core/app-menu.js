  ...
  $.app.menu = {
    ...
    manualScroller: {
      ...
      init: function () {
        ...
        if (!$.app.menu.is_touch_device()) {
          ...
          $('.main-menu1').addClass('menu-native-scroll');
        }
      },
    ...
    open: function () {
      this.transit(
        ...
        function () {
          if (!$('.main-menu').hasClass('menu-native-scroll') && $('.main-menu').hasClass('menu-fixed'),!$('.main-menu1').hasClass('menu-native-scroll') && $('.main-menu1').hasClass('menu-fixed')) {
